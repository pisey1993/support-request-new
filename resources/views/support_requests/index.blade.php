                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <div x-data="{ open: false }" class="relative inline-block text-left">
                                <button @click="open = !open" type="button"
                                        class="inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-3 py-1 bg-white text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                    ...
                                    <li>
                                        <a href="{{ route('support-requests.show', $request->id) }}"
                                           class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center">
                                            <i class="bi bi-eye mr-2" aria-hidden="true"></i> View
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('support-requests.edit', $request->id) }}"
                                           class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center">
                                            <i class="bi bi-pencil mr-2" aria-hidden="true"></i> Edit
                                        </a>
                                    </li>
                                    <li>
                                        <form action="{{ route('support-requests.destroy', $request->id) }}" method="POST"
                                            ...
                                            <button type="submit"
                                                ...
                                                <i class="bi bi-trash mr-2" aria-hidden="true"></i> Delete
                                            </button>
                                        </form>
                                    </li>
                                </ul>
